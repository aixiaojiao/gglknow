...
### v1.1.8 - 2024-12-19 ✨
- **新功能**: 添加"查看原文"按钮，方便快速追溯原始推文
- **修复**: 修复了推文浏览器中统计数据显示为0的问题

### v1.1.7 - 2024-12-19 🎨
- **界面优化**: 全新弹出界面，更简洁美观，聚焦核心设置
- **修复**: 修复推文浏览器导入不完整JSON文件时卡顿的问题

### v1.1.6 - 2024-12-19 🔧
- **修复**: 修复推文浏览器因内容安全策略（CSP）限制无法导入文件的问题
- **技术改进**: 重构代码以符合Manifest V3安全规范，提高安全性

### v1.1.5 - 2024-12-19 🎉
- **重大改进**：修复保存路径无法修改的问题
- **新增路径选择对话框**：用户现在可以选择建议路径或自定义任何路径
